...
fig.suptitle("매매 근거를 밝힌 글 26건 중 24건이 심리 주도 — 그중 절반 가까이 물렸다",
             x=0.02, y=0.95, ha="left", fontsize=13.5, fontweight="bold", color=INK)
fig.text(0.02, 0.855, "데이터를 근거로 든 매매는 단 1건. 복수매매(물타기·복구)는 4건 전원 손실 — 95% CI [76–98%]",
         ha="left", fontsize=10, color=MUTED)
fig.text(0.02, 0.04, "Source: 4개 채널 매매 언급 글 268건 전수, 독립 판정 2명 합의(kappa 0.73) 기준, 2026.08 | "
